...
local wrap = require "rv.lsp.wrap"
local config = require("rv.lsp").config_values
local if_nil = vim.F.if_nil
local hover = require "rv.lsp.hover"
local M = {}
...
local function show_diagnostics(opts, get_diagnostics)
  ...
  if show_header then
    ...
    highlights[1] = { 0, "LspDiagnosticHeader" }
  end
  ...
  api.nvim_buf_add_highlight(bufnr, -1, "LspDiagnosticTruncateLine", 1, 0, -1)
